...
::subInterfaceHeatFvPatchScalarField
(
    const subInterfaceHeatFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::subInterfaceHeatFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::subInterfaceHeatFvPatchScalarField::write
(
    Ostream& os
) const
{
